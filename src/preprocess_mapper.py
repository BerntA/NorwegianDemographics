...
for line in sys.stdin:
    ...
    line[4] = cleanupFieldOfWork(str(line[4]).lower())

    # Preprocess religion.
    # Fix faulty abbrevations and typos.
    line[6] = cleanupReligion(str(line[6]))
